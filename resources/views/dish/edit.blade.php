                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('dish.update',['dish'=>$dish]) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ $dish->name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text"
                                        ...
                                        value="{{ $dish->price }}" required autocomplete="price" autofocus>
                            ...
                            <div class="col-md-6">
                                <input  id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}"  autocomplete="restaurant_name" autofocus>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-switch">
                                        <input checked value="{{$dish->visible}}" name="visible" class="form-check-input"
